...
class ChronologieHeader extends StatelessWidget {
  const ChronologieHeader({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Expanded(child: ChronologieSearchField()),
        UserProfileCard()
      ],
    );
  }
...
class ChronologieSearchField extends StatelessWidget {
  const ChronologieSearchField({
    Key? key,
  }) : super(key: key);
